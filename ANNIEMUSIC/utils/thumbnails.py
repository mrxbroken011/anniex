...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            ...
            # Create a separate transparent layer for text
            ...
            # Fill = (R, G, B, Alpha) -> Alpha 150 makes it transparent
            wm_draw.text((1280 - wm_len - 30, 30), wm_text, fill=(255, 255, 255, 150), font=wm_font)
            
            # Merge the watermark layer with background
        ...
        # Re-initialize draw object for main text
